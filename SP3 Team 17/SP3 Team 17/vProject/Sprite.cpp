...
bool Sprite::ImageInit(void)
{
	...
	//LoadTGA(&player[0], "images/");
	//LoadTGA(&credit[0], "images/");
	//LoadTGA(&particle[0], "images/");
	//LoadTGA(&bag[0], "images/");
	//LoadTGA(&note[0], "images/");
...
bool Sprite::LoadTGA(TextureImage *texture, char *filename)			// Loads A TGA File Into Memory
{    
